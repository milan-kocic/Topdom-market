            ...
            <div className='space-y-8'>
              ...
              <div className='relative h-[400px] rounded-lg overflow-hidden'>
                <img
                  src={
                    ...
                    'https://images.unsplash.com/photo-1560393464-5c69a73c5770?ixlib=rb-4.0.3'
                  }
              ...
              <div>
                <div className='mb-6'>
                  ...
                  <div className='flex items-center space-x-2 text-sm text-gray-600'>
                    ...
                    <span className='font-medium text-yellow-600'>
                      {product.kategorije?.naziv_kategorije}
                    </span>
                  </div>
                </div>
                ...
                <div className='mb-8'>
                  ...
                  {product.status_dostupnosti === 'dostupno' ? (
                ...
                <div className='flex space-x-4'>
                  <button
                    className='p-3 border border-gray-300 rounded-lg hover:bg-yellow-50 hover:border-yellow-400 hover:text-yellow-600 transition-colors'
                  ...
                  <button
                    className='p-3 border border-gray-300 rounded-lg hover:bg-yellow-50 hover:border-yellow-400 hover:text-yellow-600 transition-colors'
                    aria-label='Podeli proizvod'
                    title='Podeli proizvod'
                  >
                  ...
                  <div className='border-t border-gray-200 pt-4 space-y-2'>
                    <div className='flex justify-between text-sm'>
                      ...
                      <span className='text-yellow-600'>
                        {subtotal.toLocaleString()} RSD
                      </span>
                    </div>
                    <div className='flex justify-between text-sm'>
                      <span>Poštarina</span>
                      <span className='text-yellow-600'>
                        {shipping.toLocaleString()} RSD
                      </span>
                    </div>
                ...
                <div>
                  <div className='relative'>
                    <input
                      ...
                      onChange={(e) =>
                        setOrderForm({ ...orderForm, telefon: e.target.value })
                      }
                ...
                <div>
                  <div className='relative'>
                    <input
                      ...
                      onChange={(e) =>
                        setOrderForm({ ...orderForm, adresa: e.target.value })
                      }
                ...
                <div>
                  <div className='relative'>
                    <input
                      ...
                      onChange={(e) =>
                        setOrderForm({ ...orderForm, grad: e.target.value })
                      }
