  ...
  return (
    <section className='relative h-[700px]'>
      <div className='absolute inset-0'>
        ...
        {/* Hero Image */}
        <div
          className={`absolute inset-0 bg-cover bg-center transition-opacity duration-500 transform-gpu will-change-transform ${
      ...
      <div className='relative container mx-auto px-6 h-full flex items-center'>
        <div className='max-w-3xl text-white'>
          ...
          <h2 className='text-6xl font-bold mb-6 leading-tight'>
            Sve za vaš dom - na klik do vas!
          </h2>
          <p className='text-2xl mb-10 text-gray-100'>
            Otkrijte našu premium kolekciju proizvoda za moderan i udoban dom po
