      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="w-48 flex items-center space-x-4">
            <button className="flex items-center space-x-2 text-sm hover:text-yellow-500 transition-all duration-200 px-3 py-2 rounded-lg hover:bg-white">
          ...
          <div className="flex-1 max-w-md mx-auto" ref={searchRef}>
            ...
            {showResults && searchQuery && (
              <div className="absolute mt-2 w-full bg-white rounded-lg shadow-lg z-[100] max-h-96 overflow-y-auto 
          ...
          <div className="w-48 flex items-center justify-end space-x-6 text-sm">
            ...
            <a href="#" className="hover:text-yellow-500 transition-colors">Dostava</a>
            <a href="#" className="hover:text-yellow-500 transition-colors">Pomoć</a>
          </div>
        </div>
      </div>
    </div>
